...
musicObj.src = "https://files.freemusicarchive.org/storage-freemusicarchive-org/music/ccCommunity/Chad_Crouch/Arps/Chad_Crouch_-_Shipping_Lanes.mp3";
...
nextBtn.addEventListener("click", () => {
  isPlaying = false;
  const resultObj = telugu.traverse(1);
